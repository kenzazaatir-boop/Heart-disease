...
# Supprimer les avertissements Streamlit
...
def load_model():
    try:
        ...
        st.error("❌ Modèle non trouvé. Assurez-vous que 'heart_disease_model.pickle' est dans le même dossier.")
        return None
...
if predict_btn and model is not None:
    ...
    st.error("❌ Impossible de charger le modèle. Vérifiez que 'heart_disease_model.pickle' existe.")
